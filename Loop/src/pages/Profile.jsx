...
export default function Profile() {
  ...
  const { name: signupName } = location.state || {};
...
// 직접 쓰기 추가 함수
  ...
  const handleSubmit = () => {
    const data = { name, birth, gender, interests, emoji };
        ...
        {step === 2 && (
          <div className="profile-step">
            ...
            <div style={{
              ...
              <span style={{ fontSize: 13, color: "var(--green-dark)", lineHeight: 1.5 }}>
        ...
        {step === 3 && (
          <div className="profile-step">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                { value: "남자", icon: "♂", label: "남자" },
                { value: "여자", icon: "♀", label: "여자" },
                { value: "기타", icon: "◎", label: "선택 안 함" },
              ].map(({ value, label }) => (
                <button
                  key={value}
          ...
          <div className="profile-step">
            ...
            {showCustomInput && (
              <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                <input
                  className="input-field"
                  style={{ width: 250, marginBottom: 0, flexShrink: 0 }}
                  placeholder="직접 입력"
                  value={customText}
                ...
                <button
                  ...
                  style={{ padding: "0 18px", fontSize: 14, borderRadius: "var(--radius-md)", flex: 1 }}
